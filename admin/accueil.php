...
include('../db.php');
if (!empty($admin)) {
    $queryC=$conn->prepare("SELECT * FROM `categorie`;");
$queryC->execute();
$resultsC=$queryC->fetchAll();

$query1C=$conn->prepare("SELECT COUNT(id_cat) FROM categorie;");
$query1C->execute();
$resC=$query1C->fetchAll();
...
$queryPr=$conn->prepare("SELECT * FROM `partner`;");
$queryPr->execute();
$resultsPr=$queryPr->fetchAll();

$query1Pr=$conn->prepare("SELECT COUNT(id_part) FROM `partner`;");
$query1Pr->execute();
$resPr=$query1Pr->fetchAll();
}else {
...
<body>
    ...
    <main>
        ...
        <section id="dashboard">
            <div class="title">Aperçu analytique</div>
            <div class="container-dashboard">
                ...
                <div class="card-ov">
                    <div class="icon">
                        <svg class="s10" version="1.1" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="number"><?php echo $resPr[0]['COUNT(id_part)'];?></div>
                    <div class="total">Totale Partenaires</div>
                </div>

            </div>
        </section>
        <section id="dahboard-description">
            <div class="container-description">
                <div class="card-desc-ui">
                    <div class="top-sec">
                        <div class="text">Categories</div>
                        <div class="icon"><svg style="enable-background:new 0 0 512 512;" version="1.1"
                ...
                <div class="card-desc-ui">
                    <div class="top-sec">
                        ...
                        <div class="icon"> <svg class="s10" version="1.1" xmlns="http://www.w3.org/2000/svg"
                                xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1000 1000"
                                enable-background="new 0 0 1000 1000" xml:space="preserve">
                                <g>
                                    <path
                    ...
                    <ul>
                        <?php
                          if (sizeof($resultsPr)>0) {
                            for ($i=0; $i <sizeof($resultsPr) ; $i++) { 
                              $part=$resultsPr[$i]['nom_part'];
                              $image=$resultsPr[$i]['image'];
                              echo"
                              <ol>
                            <span>$part</span>
                            <img src='fichiers/$image' alt=''>
                        </ol>
